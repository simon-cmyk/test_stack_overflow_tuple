...
#define SWIGTYPE_p_std__tupleT_double_double_t swig_types[2]
...
SWIGINTERN PyObject *_wrap_foo_return_thing(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  foo *arg1 = (foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "foo_return_thing" "', argument " "1"" of type '" "foo *""'"); 
  }
  arg1 = reinterpret_cast< foo * >(argp1);
  result = (arg1)->return_thing();
  resultobj = SWIG_NewPointerObj((new std::tuple< double,double >(static_cast< const std::tuple< double,double >& >(result))), SWIGTYPE_p_std__tupleT_double_double_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "foo_return_thing", _wrap_foo_return_thing, METH_O, NULL},
